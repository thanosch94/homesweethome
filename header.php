<header>
  <section class="image-left">
          <img src="images/hsh.png" width="120" height="120" />
        </section>
        <div class="clear"></div>
        <nav>
        <div class="container-fluid bg-gradient ">
          <div class="navbar row text-center text-light fw-normal">
              <a class=" nav-link col-2 shadow p-3 mb-5 bg-gradient" href="index.php">Αρχική</a>
                ...
                <a class="nav-item nav-link dropdown shadow bg-gradient p-3 mb-5 col-2" data-bs-toggle="dropdown"  href="#">Mεταφορικές</a>
                <ul class="dropdown-menu text-light">
                  <li><a class=" nav-link shadow bg-gradient p-3" href="metaforikes.php">Εύρεση Μεταφορικής</a></li>
